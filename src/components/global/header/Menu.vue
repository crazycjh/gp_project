    ...
    <div class="flex justify-between h-full">
        ...
        <div class="flex">
            <ul class="flex gap-5 items-center hidden lg:flex">
                <li class="nav-item">
                    <router-link to="/allTemple/" class="nav-link"
                        >全台廟宇</router-link
                    >
                </li>
                <li class="nav-item">
                    <router-link to="/mainGod/" class="nav-link"
                        >主神</router-link
                    >
                </li>
                <li class="nav-item">
                    <router-link to="/latest/all" class="nav-link"
                        >最新活動</router-link
                    >
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <router-link to="/product/all" class="nav-link"
                        >文創商品</router-link
                    >
                </li>
                <li class="nav-item">
    ...
    <Transition name="slide-fade">
        <div class="mobileMenu" v-show="isOpen">
            <ul class="mobileUl">
                ...
                <li class="nav-item-mobile">
                    <router-link to="/qa/" class="nav-link-mobile"
                        >Q&A</router-link
                    >
                </li>
            </ul>
...
//自製元件
import Member from "@/components/global/header/Member.vue";
import Cart from "@/components/global/header/Cart.vue";
