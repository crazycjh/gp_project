   ...
   <div class="px-10px mx-auto max-w-1200px">
      ...
      <div class="flex w-full justify-center gap-40px lg:gap-2  max-lg:flex-col text-center">
         <div class="z-10 w-full">
            <iframe class="w-full" width="586" height="329" src="https://www.youtube.com/embed/BMFmPOHany0" title="北港朝天宮正殿直播- 本服務由麥睿資訊人生地圖提供" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
