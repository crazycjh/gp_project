<template>
    <div class="relative">
        <div class="px-10px mx-auto max-w-1200px">
            <Title title="廟宇直播" />
            <div
                class="flex w-full justify-center gap-40px max-lg:flex-col text-center custom"
            >
                <div v-for="item in live" :key="item.id" class="z-10 w-full">
                    <div class="iframe_container" v-html="item.link"></div>
...
import LinkBtn from "@/components/widget/LinkBtn.vue";
