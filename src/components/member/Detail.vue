    ...
    <div class="py-40px md:px-50px">
        ...
        <div class="mb-20px flex gap-20px">
            <div class="w-full">
                ...
                <div class="relative">
                    <select class="custom_select appearance-none" v-model="selectedCity" @change="updateAreas(selectedCity)">
            ...
            <div class="w-full">
                ...
                <div class="relative">
                    <select class="custom_select appearance-none" v-model="selectedArea" @change="updateZipCode(selectedArea)">
        ...
        <div class="mb-40px flex gap-20px">
            <div class="w-full">
                ...
                <input v-model="zipCode" class="detail_input" type="text" readonly>
            </div>
            <div class="w-full">
