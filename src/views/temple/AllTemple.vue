<template>
    ...
    <TopCover
        :image="`${backend}wp-content/uploads/2023/08/temple_banner.jpg`"
        title="全台廟宇"
    />
    ...
    <div class="mx-auto max-w-1200px">
        <div class="filter_section mt-70px mb-10px px-10px hidden md:block">
            <div class="city_section mb-20px">
                <h2>找縣市</h2>
                <button
                    class="tag mr-10px mb-10px"
                    :class="{ active: activeCity === '' }"
                    @click="activeCity = ''"
                >
                    全台縣市
                </button>
            ...
            <div class="god_section mb-20px">
                ...
                <button
                    class="tag mr-10px mb-10px"
                    :class="{ active: activeGod === item }"
                    v-for="item in godsStore.originGodArray"
                    :key="item"
                    @click="activeGod = item"
                >
                    {{ item }}
                </button>
            </div>
        ...
        <div class="filter_section mt-70px mb-50px px-10px flex md:hidden">
            <div class="flex w-full mr-20px flex-col">
                <h2>找縣市</h2>
            ...
            <div class="w-full flex flex-col">
                ...
                <div class="relative w-full">
                    ...
                    <img
                        class="absolute right-0 top-0 mt-2 max-md:mr-3 mr-4 pointer-events-none"
                        src="../../assets/index/arrow_down.svg"
                        alt=""
                    />
                </div>
